...
/**
    ...
    public Reporte2() {
        initComponents();
        String column[]={"Medicamento","Tipo"};
        String matrix[][]={};
        model=new DefaultTableModel(matrix,column);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        //PARA NO REPETIR COLUMNAS
        for (int i = 0; i < tablaReporte2.getRowCount(); i++) {
            model.removeRow(i);
        }
        //recordar que medicamentos es un ArrayList
        for (int i = 0; i <medicamentos.size(); i++) {
            if(medicamentos.get(i).getTipoMedica().equals("Jarabe")){
            model.addRow(new Object[]{medicamentos.get(i).getNombre(),medicamentos.get(i).getTipoMedica()});
            }
        }
    ...
    medicamentos=a;
    this.setTitle("REPORTE MEDICAMENTOS JARABES");
